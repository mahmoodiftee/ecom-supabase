...
export default function ProductDetail({ product }: { product: Products }) {
  ...
  return (
    <div className="min-h-screen md:pb-16 md:pt-6 pb-6">
      <div ref={headerRef} className="p-4 md:hidden">
        <Link
          href="/keyboards"
      ...
      <div className="flex flex-col md:flex-row">
        <motion.div
          className="md:w-1/2 md:sticky md:top-8 flex flex-col"
        ...
        <div className="md:w-1/2 md:overflow-y-auto px-4 md:px-8 md:pt-[3.7rem] productDetailScroll">
          <div className="max-w-xl mx-auto">
            <motion.h1 className="text-3xl font-bold">
              {product.title.split(" ").map((word, index) => (
                <span
                  key={index}
                  className="relative opacity-70 overflow-hidden inline-flex"
                >
                  <motion.span
            ...
            <motion.div className="text-2xl font-bold mt-2">
